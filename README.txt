...
Add Google / Microsoft bing AJAX Translation to your blog. This plugin allows your readers to translate your blog posts, pages, or comments into 52 languages.

== Description ==

This plugin is based heavily on the Google AJAX translation plugin. It has nan updated version of jquery translate ( http://code.google.com/p/jquery-translate/)
...
3. Go to the Plugins page in your Administration Panel and click "Activate" for Jquery AJAX Translation.
...
* Jquery Ajax Translation automatically detects your source language. If your source text changes to more than one language it can get confused.
...
== Changelog ==
= 0.6.1 (Ross Tweedie) =
* Upgraded the version if JQuery translate being used.
* An API key is now required. This can either be a Google API key ( http://code.google.com/apis/language/translate/v2/getting_started.html ) or a Microsoft API Key ( https://ssl.bing.com/webmaster/Developers/ ) 
